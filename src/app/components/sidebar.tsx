  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 bg-neutral text-neutral-content h-screen fixed top-0 left-0 shadow-lg p-4 z-30">
      ...
      <nav className="flex-grow overflow-y-auto">
        <MenuTree menuItems={menuData} isMobile={true} />
      </nav>
      ...
      <div className="py-4 border-t border-gray-700 mt-auto">
        <div className="grid grid-flow-col gap-8 justify-center">
          ...
          >
            ...
            >
              <title>Facebook</title> {/* Added title element */}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube" // Added aria-label
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              ...
              className="fill-current"
            >
              <title>YouTube</title> {/* Added title element */}
          ...
          >
            <svg
              ...
              className="fill-current"
            >
              <title>LinkedIn</title> {/* Added title element */}
